...
public class FP04ArraysOperation {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Sum of rangeClosed 1 to 10 (inclusive): " + IntStream.rangeClosed(1, 10).sum());
        ...
        System.out.println("Product of first 50 numbers: " + IntStream.rangeClosed(1, 50).reduce(1, (x, y) -> x * y));

        System.out.println("Product of first 50 numbers: "
                + LongStream.rangeClosed(1, 50).mapToObj(BigInteger::valueOf).reduce(BigInteger.ONE,
                        BigInteger::multiply));
