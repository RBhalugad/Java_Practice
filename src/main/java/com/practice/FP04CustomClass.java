...
public class FP04CustomClass {
  ...
  public static void main(String[] args) {
    ...
    Comparator<Courses> compareByNoOfStudentsDescending =
        Comparator.comparingInt(Courses::getNoOfStudents).reversed();

    List<Courses> sortedCoursesDescending =
        courses.stream().sorted(compareByNoOfStudentsDescending).toList();
    ...
    Comparator<Courses> compareByReviewScoreAndNoOfStudents =
        Comparator.comparingInt(Courses::getReviewScore).thenComparingInt(Courses::getNoOfStudents);

    List<Courses> sortedCoursesAndReviewScore =
        courses.stream().sorted(compareByReviewScoreAndNoOfStudents).toList();
    ...
    List<Courses> sortedCoursesAndReviewScoreLimit =
        courses.stream().sorted(compareByReviewScoreAndNoOfStudents).limit(3).toList();
    System.out.println(
    ...
    List<Courses> sortedCoursesAndReviewScoreSkip =
        courses.stream().sorted(compareByReviewScoreAndNoOfStudents).skip(3).toList();
    System.out.println(
    ...
    List<Courses> sortedCoursesAndReviewScoreSkipLimit =
        courses.stream().sorted(compareByReviewScoreAndNoOfStudents).skip(3).limit(5).toList();
    System.out.println(
    ...
    List<Courses> sortedCoursesAndReviewScoreTakeWhile =
        courses.stream()
    ...
    // droping the element
    List<Courses> sortedCoursesAndReviewScoreDropWhile =
        courses.stream().dropWhile(course -> course.getReviewScore() >= 95).toList();
    System.out.println(
    ...
    System.out.println(
        "\nMin course (by review score and students): "
            + courses.stream()
                .min(compareByReviewScoreAndNoOfStudents)
    ...
    System.out.println(
        "Any course with review score < 90: "
    ...
    System.out.println(
        "\nTotal students (courses with review score > 95): "
            + courses.stream()
                ...
                .sum());
    System.out.println(
        "Average students (courses with review score > 95): "
            + courses.stream()
                .filter(reviewScoreGreaterThan95)
                .mapToInt(Courses::getNoOfStudents)
                .average());
    System.out.println(
        "Max students (courses with review score > 95): "
            + courses.stream()
                .filter(reviewScoreGreaterThan95)
                .mapToInt(Courses::getNoOfStudents)
                .max());
    System.out.println(
        "Min students (courses with review score > 95): "
            + courses.stream()
                .filter(reviewScoreGreaterThan95)
                .mapToInt(Courses::getNoOfStudents)
                .min());
    System.out.println(
        "Count of courses with review score > 95: "
            + courses.stream()
                .filter(reviewScoreGreaterThan95)
                .mapToInt(Courses::getNoOfStudents)
                .count());
