...
public class FP04CustomClass {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "Do all courses have a review score > 95? : " + courses.stream().allMatch(reviewScoreGreaterThan95));
        System.out.println(
                "Do no courses have a review score > 95?  : " + courses.stream().noneMatch(reviewScoreGreaterThan95));
        System.out.println(
                "Do any courses have a review score > 95? : " + courses.stream().anyMatch(reviewScoreGreaterThan95));

        System.out.println(
                "\nDo all courses have a review score < 90? : " + courses.stream().allMatch(reviewScoreLessThan90));
        System.out.println(
                "Do no courses have a review score < 90?  : " + courses.stream().noneMatch(reviewScoreLessThan90));
        System.out.println(
                "Do any courses have a review score < 90? : " + courses.stream().anyMatch(reviewScoreLessThan90));

        // 2.
        Comparator<Courses> compareByNoOfStudents = Comparator.comparingInt(Courses::getNoOfStudents);

        List<Courses> sortedCourses = courses.stream().sorted(compareByNoOfStudents).collect(Collectors.toList());
        ...
        Comparator<Courses> compareByReviewScoreAndNoOfStudents = Comparator.comparingInt(Courses::getReviewScore)
        ...
        List<Courses> sortedCoursesAndReviewScoreTakeWhile = courses.stream()
                .sorted(compareByReviewScoreAndNoOfStudents).takeWhile(course -> course.getReviewScore() >= 95)
                .collect(Collectors.toList());
        ...
        System.out.println("\nMin course (with review score < 90): "
                + courses.stream().filter(reviewScoreLessThan90).min(
                        compareByNoOfStudents).orElse(new Courses("Java 9", "Language", 99, 1000)));
        ...
        System.out.println("\nTotal students (courses with review score > 95): "
                + courses.stream().filter(reviewScoreGreaterThan95).mapToInt(Courses::getNoOfStudents).sum());
        System.out.println("Average students (courses with review score > 95): "
                + courses.stream().filter(reviewScoreGreaterThan95).mapToInt(Courses::getNoOfStudents).average());
        System.out.println("Max students (courses with review score > 95): "
                + courses.stream().filter(reviewScoreGreaterThan95).mapToInt(Courses::getNoOfStudents).max());
        System.out.println("Min students (courses with review score > 95): "
                + courses.stream().filter(reviewScoreGreaterThan95).mapToInt(Courses::getNoOfStudents).min());
        System.out.println("Count of courses with review score > 95: "
                + courses.stream().filter(reviewScoreGreaterThan95).mapToInt(Courses::getNoOfStudents).count());
        ...
        System.out.println("\nHighest reviewed course in each category: \n" 
                + courses.stream()
                        .collect(Collectors.groupingBy(Courses::getCategory,
                                Collectors.maxBy(Comparator.comparingInt(Courses::getReviewScore)))));
